...
import { Dt as c, N as l, Q as u, s as d } from "./framer.BLOKjrOc.mjs";
function f(e, t, n) {
      ...
      (p = class {
        ...
        advance(e) {
          ...
          if (this.duration && this.easing) {
            this.currentTime += e;
            let t = f(0, this.currentTime / this.duration, 1);
            n = t >= 1;
            ...
            this.lerp
              ...
              : ((this.value = this.to), (n = !0));
          (n && this.stop(),
            (t = this.onUpdate) == null || t.call(this, this.value, n));
        }
        stop() {
          this.isRunning = !1;
        }
        ...
        constructor({
          ...
          ((this.__isScrolling = !1),
            ...
            (this.onVirtualScroll = (e) => {
              ...
              if (
                ((this.isTouching =
                  r.type === `touchstart` || r.type === `touchmove`),
  ...
  return (
    ...
    n(() => {
      let e = () => {
        try {
          ...
          a.current && (e || n ? a.current.stop() : a.current.start());
        } catch (e) {
    ...
    n(() => {
      try {
        ...
        a.current = new v({ duration: (t || 10) / 10 });
        let e = (t) => {
            if (a.current)
              try {
                (a.current.raf(t), requestAnimationFrame(e));
              } catch (e) {
        ...
        return () => {
          if ((cancelAnimationFrame(n), a.current))
            try {
          ...
          t = (e, t, n) => {
            try {
              (e && e.preventDefault && e.preventDefault(),
                a.current && t && a.current.scrollTo(t, { offset: -(n || 0) }));
            } catch (e) {
...
function w(e, t) {
  return {
    favicon: `https://framerusercontent.com/assets/7DgqvYNPSnNCt9oDtXMipoAH22A.png`,
    robots: `max-image-preview:large`,
    title: `KFD`,
  };
}
var T = e(() => {});
export { C as i, w as n, S as r, T as t };
//# sourceMappingURL=shared-lib.CFi5o8rJ.mjs.map
